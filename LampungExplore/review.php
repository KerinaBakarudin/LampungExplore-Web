...
<header>
    ...
    <nav>
        <ul>
            ...
            <li><a href="review.php" class="active">Rating and Review</a></li>
        ...
        <?php while ($data = mysqli_fetch_assoc($query_mysql)) { ?>
            <div class="box">
                <div class="actions">
                    ...
                    <!-- Icon hapus -->
                    <a href="conn/deletekomen.php?id=<?php echo $data['id']; ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus review ini?');"><i class="fas fa-trash-alt"></i></a>
                </div>
